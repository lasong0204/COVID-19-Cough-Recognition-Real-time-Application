...
|아키텍쳐|
|:---:|
|<img src="./image/image_5_5.png" width="700" height="250">|
...
|데모시현장면|
|:---:|
|[![Video Label](http://i.ytimg.com/vi/r1VyT-XlYts/hqdefault.jpg)](https://youtu.be/r1VyT-XlYts)|
 


### 2. 개선방향
* 성능 향상
   * 데이터 변형, 잡음 제거 및 데이터 추가 확보
   * COVID19 분류 시 60% -> 80% 이상의 정확도 추구
 
 

* 활용도 확장
   * 다양한 환경에서 운영 가능한 웹서비스 구축
   * 사용자 중심 UI 개선
